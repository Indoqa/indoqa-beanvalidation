...
public class PrimitiveArrayValidation extends AbstractCollectionsValidations<int[]> {
    ...
    @Override
    protected PropertyValidator<SimpleBean, int[]> getPropertyValidator() {
        return PropertyValidator.forMethod(SimpleBean::getInts);
    }

    @Override
    protected void setNonEmptyValue(SimpleBean simpleBean) {
        simpleBean.setInts(new int[1]);
    }

    @Override
    protected void setNullValue(SimpleBean simpleBean) {
        simpleBean.setInts(null);
    }

    @Override
    protected void setEmptyValue(SimpleBean simpleBean) {
        simpleBean.setInts(new int[0]);
    }
}
