...
public class ListValidation extends AbstractCollectionsValidations<List> {
    ...
    @Override
    protected PropertyValidator<SimpleBean, List> getPropertyValidator() {
        return PropertyValidator.forMethod(SimpleBean::getMessages);
    }

    @Override
    protected void setNonEmptyValue(SimpleBean simpleBean) {
        simpleBean.setMessages(Collections.singletonList("value"));
    }
